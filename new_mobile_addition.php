...
<html lang="en">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body>
      ...
      <label class="control-label col-sm-2" for="first_name">MOBILE NAME</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="book_name" placeholder="first name" name="book_name">
      </div>
        </div>
                 <div class="form-group">
      <label class="control-label col-sm-2" for="first_name">MOBILE PRICE</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="book_price" placeholder="first name" name="book_price">
      </div>
        </div>
                 <div class="form-group">
      <label class="control-label col-sm-2" for="first_name">MOBILE DESCRIPTION</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="book_description" placeholder="first name" name="book_description">
                 ...
                 <div class="form-group">
      <label class="control-label col-sm-2" for="image">MOBILE PICTURE:</label>
      <div class="col-sm-2">
...
<input type="file" id="imageUpload" accept="image/*" style="display: none" name="image">
   ...
   $query="INSERT INTO mobile values('$book_name','$book_price','$book_description','$imagename')";
