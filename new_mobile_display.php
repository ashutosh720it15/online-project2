...
<html lang="en">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   $dbc= mysqli_connect('localhost', 'root', '', 'online_shopping')or die('could not connect to the databases');
   $query="SELECT * FROM  mobile WHERE mobile_name='".$variable."'";
   $data= mysqli_query($dbc, $query);
   ...
   else
   {
       ...
       echo'<h1><b>MOBILE NAME</b></h1>'.$row['mobile_name'];
       echo'<br />';
       echo'<h1><b> MOBILE PRICE</b></h1>'.$row['mobile_price'];
       echo'<br />';
       echo'<h1><b> MOBILE DESCRIPTION</b></h1>'.$row['mobile_description'];
       echo'<br />';
       echo"<p><img src=".$row['mobile_picture']."></p>";
       echo'<br />';
        echo'<a href="new_buy1.php" class="btn btn-primary"><b>ADD TO CART</b></a>';
        echo'<br />';
       echo'<p><a href="front_page.php" class="btn btn-primary">HOME PAGE</a></p>';
       
       session_start();
       $_SESSION['product']=$row['mobile_name'];
       $_SESSION['product_type']='mobile';
